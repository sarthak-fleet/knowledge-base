/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f58cea4df70fa1d6b7d2fff4c6ee628a)
// Runtime types generated with workerd@1.20260617.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	RAW_DOCS: R2Bucket;
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	VECTORIZE_SMALL: VectorizeIndex;
	RAG_ANALYTICS: AnalyticsEngineDataset;
	INGEST_QUEUE: Queue;
	AI: Ai;
	EMBEDDING_MODEL: "@cf/baai/bge-base-en-v1.5";
	EMBEDDING_MODEL_SMALL: "@cf/baai/bge-small-en-v1.5";
	RAG_AI_GATEWAY_CACHE_TTL_SECONDS: "3600";
	RAG_CACHE_ENABLED: "true";
	RAG_CACHE_TTL_SECONDS: "300";
	RAG_CACHE_MAX_ENTRIES: "1000";
	KB_INGEST_WORKFLOW: Workflow<Parameters<import("./src/index").KbIngestWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMBEDDING_MODEL" | "EMBEDDING_MODEL_SMALL" | "RAG_AI_GATEWAY_CACHE_TTL_SECONDS" | "RAG_CACHE_ENABLED" | "RAG_CACHE_TTL_SECONDS" | "RAG_CACHE_MAX_ENTRIES">> {}
}
